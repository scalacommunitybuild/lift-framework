  ...
  with MongoMeta[BaseRecord, BaseRecord]
{
  ...
  @deprecated("Use useCollectionAsync instead", "3.4.0")
  ...
  @deprecated("Use saveOperation instead", "3.4.0")
  ...
  @deprecated("Use insertOneAsync instead", "3.4.0")
   ...
   *
   */
  @deprecated("Use replaceOneScalaAsync instead.", "3.4.0")
   ...
   * Save the instance in the appropriate backing store
   */
  @deprecated("Set WriteConcern in MongoClientOptions or on this MongoMetaRecord", "3.4.0")
   ...
   */
  @deprecated("Use updateOne, updateMany, or replaceOne instead", "3.4.0")
   ...
   */
  @deprecated("Use updateMany instead", "3.4.0")
   ...
   */
  @deprecated("Use updateOne, or replaceOne instead", "3.4.0")
